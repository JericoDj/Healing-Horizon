...
const DESTINATIONS = [
  ...
  },
  {
    ...
    icon: 'hearts',
    label: 'What we offer',
    description: 'Individual, couples, family, teen, trauma and group therapy.',
  },
  {
    to: paths.therapists,
    icon: 'group',
    label: 'Our therapists',
    description: 'Who works here, what they treat, and who has space.',
  },
  {
    to: paths.rates,
    icon: 'info',
    label: 'Rates & insurance',
    description: 'What sessions cost and which plans we are in network with.',
  },
  {
    to: paths.contact,
    icon: 'mail',
    label: 'Contact us',
    description: 'Send a message and we will reply within one business day.',
  },
  {
    to: paths.book,
    icon: 'calendar',

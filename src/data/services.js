...
export const services = [
  {
    ...
    icon: 'home',
    summary:
      'Hands-on coaching in personal hygiene, budgeting, meal planning, nutrition, time management, and household upkeep.',
    forWho: 'Adults & Transitional Youth',
    format: 'In-home & community settings',
    duration: 'Individualized sessions',
    cadence: 'Per Rehabilitation Plan (IRP)',
    rate: 'Medicaid Covered',
    featured: true,
    intro:
  ...
  },
  {
    ...
    name: 'Symptom Self-Management & Wellness',
    icon: 'sparkle',
    summary:
      'Education and coaching to recognize relapse warning signs, develop coping strategies, regulate emotions, and prevent crises.',
    forWho: 'Adults & Transitional Youth',
  ...
  },
  {
    ...
    name: 'Community Resource Linkage & Care Coordination',
    icon: 'leaf',
    summary:
      'Support navigating housing assistance, SSI/SSDI and Medicaid benefits, food resources, transportation, and healthcare.',
    forWho: 'Adults & Transitional Youth',
  ...
  },
  {
    ...
    icon: 'book',
    summary:
      'Employment readiness, job search, interview preparation, workplace skill building, GED programs, and supported employment.',
    forWho: 'Adults & Transitional Youth',
  ...
  },
  {
    ...
    name: 'Medication Support & Education',
    icon: 'shieldCheck',
    summary:
      'Non-prescribing medication education, adherence routine building, side-effect tracking, and coordination with prescribing clinicians.',
  ...
  },
  {
    ...
    icon: 'group',
    summary:
      'Support with communication, conflict resolution, building healthy relationships, and active social and community participation.',
    forWho: 'Adults & Transitional Youth',
  ...
  },
  {
    ...
    icon: 'shield',
    summary:
      'Individualized crisis prevention plans, de-escalation strategies, emergency protocols, and coordination with mobile crisis teams.',
  ...
  },
  {
    ...
    icon: 'hearts',
    summary:
      'Involving consented family members, caregivers, and natural supports to strengthen participant stability and community success.',
